...
INSERT INTO "app_example" (name, url, source, category) VALUES
    ...
    --('covenant_dcsync_all','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/covenant_dcsync_all.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    --('covenant_lsacache','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/covenant_lsacache.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    --('covenant_lsasecrets','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/covenant_lsasecrets.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    --('covenant_mimikatz_logonpasswords','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/covenant_mimikatz_logonpasswords.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    ...
    --('empire_extended_netntlm_downgrade','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/empire_extended_netntlm_downgrade.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    ...
    --('empire_rubeus_asktgt_ptt','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/empire_rubeus_asktgt_ptt.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    --('empire_rubeus_asktgt_ptt_createnetonly','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/empire_rubeus_asktgt_ptt_createnetonly.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    --('interactive_taskmngr_lsass_dump','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/interactive_taskmngr_lsass_dump.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    --('remoteinteractive_taskmngr_lsass_dump','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/credential_access/host/remoteinteractive_taskmngr_lsass_dump.tar.gz','https://github.com/hunters-forge/mordor','Credential_Access'),
    ...
    --('covenant_installutil','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/defense_evasion/host/covenant_installutil.tar.gz','https://github.com/hunters-forge/mordor','Defense_Evasion'),
    --('covenant_msbuild_grunt','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/defense_evasion/host/covenant_msbuild_grunt.tar.gz','https://github.com/hunters-forge/mordor','Defense_Evasion'),
    ...
    --('covenant_psremoting_grunt','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/lateral_movement/host/covenant_psremoting_grunt.tar.gz','https://github.com/hunters-forge/mordor','Lateral_Movement'),
    ...
    --('covenant_persiststartup','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/persistence/host/covenant_persiststartup.tar.gz','https://github.com/hunters-forge/mordor','Persistence'),
    --('covenant_persistwmi','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/persistence/host/covenant_persistwmi.tar.gz','https://github.com/hunters-forge/mordor','Persistence'),
    ...
    ('empire_invoke_runas','https://github.com/hunters-forge/mordor/raw/master/datasets/small/windows/privilege_escalation/host/empire_invoke_runas.tar.gz','https://github.com/hunters-forge/mordor','Privilege_Escalation')
;